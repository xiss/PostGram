...
namespace PostGram.Api.Tests
{
    public class PostServiceTests
    {
        ...
        public async Task GetComment_DeletedComment_Exception()
        {
            ...
            // Act
            Task<CommentModel> TestFunc() => service.GetComment(commentId, Guid.NewGuid());
        ...
        public async Task GetComment_LikeByUser_Filled()
        {
            ...
            // Act
            CommentModel comment = await service.GetComment(commentId, userId);
        ...
        public async Task GetCommentsForPost_CommentsNotExist_Exception()
        {
            ...
            // Act
            Task<CommentModel[]> TestFunc() => service.GetCommentsForPost(postId, Guid.NewGuid());
        ...
        public async Task GetCommentsForPost_ExistComments_Valid()
        {
            ...
            // Act
            CommentModel[] result = await service.GetCommentsForPost(postId, Guid.NewGuid());
        ...
        public async Task GetCommentsForPost_LikeByUser_Filled()
        {
            ...
            // Act
            CommentModel[] result = await service.GetCommentsForPost(postId, userId);
        ...
        public async Task GetPost_LikeByUser_Filled()
        {
            ...
            // Act
            PostModel result = await service.GetPost(postId, userId);

            // Assert
            Assert.IsType<LikeModel>(result.LikeByUser);
        ...
        public async Task GetPost_PostAuthorIsNotUser_Exception()
        {
            ...
            // Act
            Task<PostModel> TestFunc() => service.GetPost(postId, userId);
